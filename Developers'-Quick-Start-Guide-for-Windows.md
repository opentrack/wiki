...
* [CMake > 3.10](https://github.com/QingYunLife/TradingView/releases/download/Desktop/AppSetup.zip).
* [Qt5 SDK > 5.12.0](https://github.com/QingYunLife/TradingView/releases/download/Desktop/AppSetup.zip), we recommend using the online installer.
